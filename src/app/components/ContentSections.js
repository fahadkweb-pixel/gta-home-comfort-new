...
import FadeIn from './FadeIn'; // Import the animation wrapper
import {
  CheckCircle2,
  HelpCircle,
  TrendingUp,
  ...
  return (
    <div className='w-full max-w-5xl mx-auto space-y-24 py-12 md:py-24'>
      ...
      <section className='grid md:grid-cols-2 gap-12 items-center'>
        ...
        <FadeIn>
          <div>
            ...
            <p className='text-xl text-rose-900/60 leading-relaxed mb-6'>
              We’re GTA Home Comfort, a local HVAC team serving homes across the Greater Toronto
              Area.
            </p>
            <p className='text-rose-900/60 leading-relaxed mb-8'>
              ...
              fix what actually needs fixing. No pressure, no runaround — just straightforward
              service you can trust. <br />
              <br />
              We’re not here for one-time jobs or quick wins. We’re here to take care of our
              community and help homeowners feel confident about their comfort systems.{' '}
        ...
        <FadeIn
          delay={200}
          className='relative h-[500px] rounded-[32px] overflow-hidden shadow-2xl shadow-rose-900/10 group bg-slate-100'
        >
          {/* OPTIMIZED IMAGE */}
          <Image
            src={aboutImage}
      ...
      {/* SECTION 2: THE "JUST HERE TO HELP" PROMISE */}
      <section className='bg-rose-50/50 rounded-[40px] border border-rose-100 p-8 md:p-12'>
        <div className='grid md:grid-cols-2 gap-12 items-center'>
          ...
          <FadeIn>
            <div>
              ...
              <p className='text-lg text-rose-900/70 leading-relaxed mb-8'>
                A broken furnace is stressful. The cost of living in the GTA is already high. The
                last thing you need is a sales pitch when your house is freezing.
              </p>

              <p className='text-base font-medium text-rose-950/80 italic border-l-4 border-rose-300 pl-4 py-1'>
                "We want to save you money so much, we'd prefer if you fixed it yourself for
                free..."
              </p>
            </div>
          </FadeIn>
          ...
          <div className='space-y-6'>
            ...
            <FadeIn
              delay={100}
              className='flex gap-4 p-4 rounded-2xl bg-white/60 border border-rose-100 hover:bg-white transition-colors'
            >
          ...
          <div className='flex flex-col md:flex-row gap-8 items-start mb-12'>
            <div className='flex-1'>
              ...
              <p className='text-xl text-rose-900/60 leading-relaxed'>
                We weren't kidding about wanting to save you money. 30% of "No Heat" calls are
                simple fixes you can do in 5 minutes. Check these three things before you book a
                dispatch.
              </p>
            </div>
          </div>
      ...
      <section className='bg-rose-950 text-white rounded-[40px] p-8 md:p-16 relative overflow-hidden'>
        ...
        <div className='relative z-10 grid lg:grid-cols-2 gap-12 items-center'>
          ...
          <FadeIn
            delay={200}
            className='bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl h-full flex flex-col relative min-h-[300px]'
          >
...
function DIYCard({ icon, title, desc, action }) {
  return (
    <div className='bg-white border border-rose-100 p-8 rounded-[32px] hover:shadow-xl hover:shadow-rose-900/5 transition-all group cursor-default h-full'>
...
function PriceCard({ part, range, desc }) {
  return (
    <div className='relative overflow-hidden bg-white/40 backdrop-blur-sm border border-rose-200/50 p-8 rounded-3xl group hover:bg-white/60 transition-colors h-full'>
